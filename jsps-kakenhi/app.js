...
const I18N = {
  zh: {
    ...
    home: {
      keyline: "官方页面 · 表格 · 截止时间",
      heroTitle: "JSPS 科研费门户",
      focusLabel: "今年重点",
      focusNote: "官方页面、表格与截止时间入口。",
      lede: "围绕 JSPS 官方页面，优先整理研究活動スタート支援与若手研究，并保留本地快照归档。",
      snapshotTitle: "当前快照",
  ...
  en: {
    ...
    home: {
      keyline: "Official pages · forms · deadlines",
      heroTitle: "JSPS KAKENHI Portal",
      focusLabel: "Current priorities",
      focusNote: "Official pages, forms, and deadlines.",
      lede: "Built around official JSPS pages, with Start-up Support, Early-Career Scientists, and local snapshots kept in view.",
