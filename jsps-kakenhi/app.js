...
const I18N = {
  zh: {
    ...
    home: {
      ...
      focusLabel: "今年重点",
      focusNote: "从官方页面、PDF、表格家族到申请时间线的一站式入口。",
      lede: "这个站点只围绕 JSPS 官方页面做整理，优先把今年最关键的研究活動スタート支援和若手研究放在最前，同时保留快照归档与 GitHub Pages 风格的公开发布结构。",
      snapshotTitle: "当前快照",
      prioritySection: "重点项目总览",
      guideSection: "今年最该盯住的内容",
      watchTitle: "行动提醒",
      jumpTitle: "官方快速跳转",
      sourceSection: "官方入口与本地镜像",
    },
    calls: {
      kicker: "项目浏览",
      title: "项目目录",
  ...
  en: {
    ...
    home: {
      ...
      focusNote: "One entry point for official pages, PDFs, form families, and the application timeline.",
      lede: "This site stays anchored to official JSPS pages, surfaces Research Activity Start-up Support and Early-Career Scientists first, and keeps a local snapshot archive alongside a GitHub Pages-ready source layout.",
      snapshotTitle: "Current snapshot",
      prioritySection: "Priority overview",
      guideSection: "What to keep watching this year",
      watchTitle: "Action reminders",
      jumpTitle: "Official quick links",
      sourceSection: "Official entry points and mirrors",
    },
    calls: {
