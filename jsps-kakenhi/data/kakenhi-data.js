window.KAKENHI_PORTAL_DATA = {
  ...
  "programs": [
    {
      ...
      "family_title": "研究活動スタート支援",
      "family_title_ja": "研究活動スタート支援",
      "family_title_zh": "研究活动启动支援",
      "family_title_en": "Research Activity Start-up Support",
      "group": "重点项目",
      "group_ja": "重点種目",
      "group_zh": "重点项目",
      "group_en": "Priority programs",
      "priority": true,
      "theme": "toyama",
      ...
      "card_summary_ja": "新たに研究機関へ着任した研究者や、育児休業等を経て研究を再始動する研究者向けの立ち上げ支援です。e-Rad の応募資格、学内締切、S-22 の準備を早めにそろえるのが要点です。",
      "card_summary_zh": "面向新近受聘于研究机构、或因育儿等原因中断后重新启动研究的研究者。重点是尽早确认 e-Rad 申请资格、校内截止与 S-22 全套材料。",
      "card_summary_en": "Designed for newly appointed researchers and for applicants restarting research after interruptions such as childcare leave. The essentials are to secure e-Rad eligibility early and line up the institutional deadline and the full S-22 package.",
      "eligibility_ja": "新たに研究機関へ採用された研究者や、育児休業等を経て研究を再開する研究者を主な対象とする種目です。学内締切、e-Rad 上の応募資格、S-22 の準備状況を早めに確認してください。",
      "eligibility_zh": "该项目主要面向新任教员，以及经历育儿休假等研究中断后重新启动研究的申请者。请尽早核对校内截止、e-Rad 応募资格以及 S-22 套件准备情况。",
      "eligibility_en": "This program mainly targets newly appointed researchers and applicants restarting research after interruptions such as childcare leave. Confirm your institutional deadline, e-Rad eligibility, and S-22 preparation status as early as possible.",
      "watchpoints_ja": [
      ...
      "watchpoints_zh": [
        ...
        "电子申报系统可自 2026-03-19 起使用，但如果 e-Rad 的応募资格尚未完成赋予，整体提交流程仍可能被拖慢。",
      ...
      "snapshot_history": [
        {
          "title_ja": "2026-04-08 スナップショット",
          "title_zh": "2026-04-08 快照",
          "title_en": "2026-04-08 snapshot",
    ...
    },
    {
      ...
      "card_summary_ja": "博士取得後まもない若手研究者が独立した課題を育てるための主要種目です。共通公募ページで審査区分表、S-21、Web入力要領、研究計画調書の構成を一式確認します。",
      "card_summary_zh": "面向博士毕业后不久、正在形成独立研究课题的青年研究者。应在共用公募页成套核对审查区分表、S-21、Web 输入要领与研究计划书结构。",
      "card_summary_en": "Main KAKENHI track for early-career researchers developing an independent agenda soon after the doctorate. Use the shared call page to review the review sections, S-21, web-entry guidance, and the full proposal structure as one set.",
      "eligibility_ja": "若手研究を準備する場合は、この共通ページで公募要領、審査区分表、S-21、Web入力要領、研究計画調書の全体イメージをまとめて確認します。",
      "eligibility_zh": "准备“青年研究（若手研究）”时，应优先在这个共用页面核对公募要领、审查区分表、S-21、Web 输入要领以及研究计划书整体样例。",
      "eligibility_en": "Use this shared page to confirm the application procedures, the review section table, the S-21 form family, the web-entry guidance, and the full proposal-image samples for Early-Career Scientists.",
      "watchpoints_ja": [
      ...
      "key_links": [
        ...
        },
        {
          "label": "预计日程通知",
          "label_ja": "公募予定通知",
          "label_en": "Schedule notice",
          "href": "https://www.jsps.go.jp/file/storage/kaken_g_4570/r8jimurenraku.pdf",
          "kind": "file"
        },
        {
          "label": "预计日程快照",
          "label_ja": "予定日程スナップショット",
          "label_en": "Schedule snapshot",
      ...
      "forecast_cycle": {
        ...
        "label_ja": "令和9(2027)年度公募予定",
        "label_zh": "2027年度预计公募日程",
        "label_en": "FY2027 planned call schedule",
    ...
    },
    {
      ...
      "card_summary_ja": "海外研究者を日本へ招へいする長期・短期プログラムをまとめた制度です。募集回ごとに長期と短期の扱いが異なるため、まず該当ラウンドと対象区分を切り分けて確認します。",
      "card_summary_zh": "这是把海外研究者赴日招へい的长期与短期项目整合在一起的制度入口。由于不同轮次覆盖的长期/短期区分并不相同，应先分清所属轮次与项目类型。",
      "card_summary_en": "Combined entry for the long-term and short-term invitation programs that bring overseas researchers to Japan. Because not every round covers the same route mix, first identify the relevant round and whether it is the long-term or short-term track.",
    ...
    },
    {
      ...
      "card_summary_ja": "海外の研究者を日本へ招へいする外国人特別研究員制度の一般・欧米短期・公募ルートをまとめた入口です。募集要項ページと各スケジュールページが分かれるため、対象ルートを決めたうえで締切を個別に確認します。",
      "card_summary_zh": "这是把将海外研究者招募至日本开展研究的外国人特别研究员制度中“一般／欧美短期／公募”路线合并整理的入口。由于募集要项页与各日程页分开，应先确定路线，再逐一核对截止。",
      "card_summary_en": "Entry point for the General, Open Short-Term, and related open tracks of the JSPS postdoctoral fellowships that bring overseas researchers to Japan. Because the guideline page and the individual schedule pages are separate, decide the route first and then confirm deadlines on the matching schedule page.",
    ...
    },
    {
      ...
      "system_available_from": null,
      "call_open_date": null,
      "call_open_label_ja": "2026年3月中旬",
      "call_open_label_zh": "2026年3月中旬",
      "call_open_label_en": "Mid-Mar 2026",
      ...
      "card_summary_ja": "日本の若手研究者が海外機関で研究経験を積むための派遣フェロー制度です。受入機関との調整が必要なため、募集要項に加えて受入意思確認書や評価書の準備時期を早めに固めます。",
      "card_summary_zh": "面向日本青年研究者赴海外机构开展研究的派遣 fellowship。由于需要与接收机构协调，除了募集要项外，还应尽早安排受入确认书和评价书的准备节奏。",
      "card_summary_en": "Outbound fellowship for early-career researchers from Japan to conduct research at overseas institutions. Because coordination with the host institution is essential, plan the host-confirmation and evaluation documents early along with the main guidelines.",
    ...
    },
    {
      ...
      "card_summary_ja": "研究中断からの再始動を支える海外派遣型の特別研究員枠です。通常の海外特別研究員と日程は共有しますが、RRA 専用の別紙様式と制度趣旨への適合説明が要点になります。",
      "card_summary_zh": "这是支持研究中断后再次启动、并赴海外开展研究的特别研究员项目。虽然与通常海外特别研究员共用日程，但重点在于 RRA 专用附表及对制度宗旨的说明。",
      "card_summary_en": "Overseas fellowship route for restarting research after an interruption. It shares the calendar of the standard overseas fellowship, but the key requirements are the RRA-specific annex forms and a clear explanation of fit with the scheme purpose.",
    ...
    },
    {
      ...
      "system_available_from": null,
      "call_open_date": null,
      "call_open_label_ja": "2026年4月上旬",
      "call_open_label_zh": "2026年4月上旬",
      "call_open_label_en": "Early Apr 2026",
      ...
      "card_summary_ja": "博士取得者向け PD と博士課程学生向け DC1・DC2 をまとめた主力フェロー制度です。自分が PD か DC かを先に確定し、対応する募集要項・作成要領・Q&A を取り違えずに確認します。",
      "card_summary_zh": "这是面向博士毕业者的 PD 与面向博士阶段学生的 DC1/DC2 主体 fellowship 制度。重点是先确定自己属于 PD 还是 DC，再对应核对募集要项、作成要领与 Q&A。",
      "card_summary_en": "Main fellowship scheme covering PD for recent doctorate holders and DC1/DC2 for doctoral students. First fix whether the application is for PD or DC, then review the matching guidelines, proposal instructions, and FAQ without mixing tracks.",
    ...
    },
    {
      ...
      "card_summary_ja": "育児等による研究中断後の復帰を支える特別研究員枠です。RPD 専用の募集要項、提出確認資料、採用開始日の扱いを PD/DC と分けて確認する必要があります。",
      "card_summary_zh": "面向因育儿等原因中断研究后回归科研的特别研究员项目。必须将 RPD 专用募集要项、提交确认资料与采用开始日安排，同 PD/DC 明确区分开来核对。",
      "card_summary_en": "Research-fellow track for restarting research after interruptions such as childcare. The RPD-specific guidelines, submission checks, and appointment-start options must be reviewed separately from the PD/DC routes.",
    ...
    },
    {
      ...
      "card_summary_ja": "独立直後の研究基盤を整えたい研究者を後押しする試行支援です。関連する基盤研究(C)・若手研究との関係を踏まえ、応募資格と必要様式を先に確認してから準備を進めます。",
      "card_summary_zh": "这是面向希望在独立初期稳固研究基础的研究者的试行性支援项目。应结合其与基盘研究(C)和青年研究的关系，先确认申请资格与所需样式。",
      "card_summary_en": "Pilot support scheme for researchers who need to consolidate their research base in the early stage of independence. Review the eligibility and required forms first, in relation to the linked Scientific Research (C) and Early-Career tracks.",
    ...
    },
    {
      ...
      "card_summary_ja": "国際共同研究を日本側から主導する大型計画向けの加速基金です。研究代表者の主導性、国際連携の必然性、S-64 を含む大型計画としての整合性が重視されます。",
      "card_summary_zh": "面向由日方主导国际共同研究的大型加速基金项目。重点在于研究代表人的主导性、国际合作的必要性，以及包含 S-64 在内的大型计划整体一致性。",
      "card_summary_en": "Acceleration fund for large international collaborations led from Japan. The proposal must show principal-investigator leadership, a clear need for the international collaboration, and strong coherence as a large-scale plan including the S-64 requirements.",
    ...
    },
    {
      ...
      "card_summary_ja": "既存の研究基盤を活かして国際共同研究を一段強化したい研究者向けの加速基金です。元になる研究計画との接続、海外連携の役割分担、追加的に必要な活動内容を明確に示す必要があります。",
      "card_summary_zh": "面向希望在既有研究基础上进一步强化国际共同研究的研究者。需要清楚说明它与原有研究计划的衔接、海外合作分工以及新增活动的必要性。",
      "card_summary_en": "Acceleration fund for researchers who want to strengthen international collaboration on top of an existing research base. The proposal should clearly explain how the new plan connects to the underlying project, how roles are divided internationally, and why the added activities are necessary.",
      ...
      "forecast_cycle": {
        "source_url": "https://www.jsps.go.jp/file/storage/kaken_g_4570/r8jimurenraku.pdf",
        "label_ja": "令和8(2026)年度公募予定",
        "label_zh": "2026年度预计公募日程",
        "label_en": "FY2026 planned call schedule",
        "call_open_date": "2026-07-14",
        "submission_deadline": "2026-09-17",
        "source_path": "external/jsps/2026-04-08/kaken_r8_schedule_notice.pdf"
      }
    },
    {
      ...
      "card_summary_ja": "海外で研究してきた研究者が帰国後に研究を立ち上げ直すための国際系支援です。帰国後の受入体制、研究の継続性、国内で再構築する計画の具体性が要点です。",
      "card_summary_zh": "面向在海外开展研究后回国重建科研工作的研究者的国际类支援项目。重点是回国后的接收体制、研究连续性以及在国内重建计划的具体性。",
      "card_summary_en": "International support track for researchers returning to Japan after working abroad. The essentials are the post-return host structure, continuity from the previous research, and a concrete plan for rebuilding the project in Japan.",
    ...
    },
    {
      ...
      "card_summary_ja": "海外研究機関との継続的な共同体制を築くための国際共同研究枠です。相手機関との役割分担、共同計画の実行性、国内研究計画との接続を具体的に示す必要があります。",
      "card_summary_zh": "面向与海外研究机构建立持续合作体制的国际共同研究项目。需要具体说明双方分工、共同计划的可执行性，以及它与国内研究计划的衔接。",
      "card_summary_en": "International-collaboration track for building an ongoing partnership with overseas research institutions. The proposal needs concrete role sharing with the partner institution, an executable joint plan, and a clear connection to the domestic research agenda.",
    ...
    },
    {
      ...
      "card_summary_ja": "大学等の研究機関に所属する研究者が、自らの基盤的研究を継続的に進める主力種目です。A・B・C の規模差を見極め、該当する様式と審査区分を対応づけて準備します。",
      "card_summary_zh": "面向高校等研究机构研究者持续推进自身基础性课题的主力项目。应先判断 A/B/C 的规模层级，再对应核对表格与审查区分。",
      "card_summary_en": "Core scheme for researchers at universities and other research institutions to pursue sustained foundational projects. First decide whether A, B, or C matches the scale, then prepare against the corresponding forms and review sections.",
    ...
    },
    {
      ...
      "card_summary_ja": "高い研究実績を持つ研究者が、大規模で発展性の高い課題を主導するための種目です。計画規模に見合う研究体制と S-11 の記載要求を先に押さえるのが重要です。",
      "card_summary_zh": "面向具有较强研究积累、拟主导大规模高发展性课题的研究者。重点是先确认与项目体量相匹配的研究体制，以及 S-11 的填写要求。",
      "card_summary_en": "For researchers with strong track records who will lead large-scale, high-growth projects. The key is to establish a research structure commensurate with the project scale and understand the S-11 requirements early.",
    ...
    },
    {
      ...
      "card_summary_ja": "教育・実務・地域現場で得た着想を個人研究として形にしたい人向けの小規模種目です。通常の科研費と応募資格の範囲が異なるため、対象者条件と提出区分を最初に確認します。",
      "card_summary_zh": "面向希望把教育、实务或区域现场中的问题意识发展为个人研究的小规模项目。由于申请资格范围与通常科研费不同，应最先确认对象条件与提交区分。",
      "card_summary_en": "Small-scale scheme for turning ideas from education, practice, or community settings into individual research. Because the eligibility scope differs from standard KAKENHI tracks, confirm the applicant conditions and submission category first.",
    ...
    },
    {
      ...
      "card_summary_ja": "高リスクでも挑戦価値の高い着想を研究課題として打ち出すための種目です。開拓か萌芽かを先に切り分け、対応する計画調書様式と添付ファイル要領を確認します。",
      "card_summary_zh": "面向高风险但具有高挑战价值的创新构想。应先区分属于“开拓”还是“萌芽”，再核对对应计划书样式与附件填写要领。",
      "card_summary_en": "For bold, high-risk ideas worth pursuing as research programs. Decide first whether the proposal belongs to the pioneering or exploratory track, then confirm the matching proposal forms and attachment instructions.",
    ...
    },
    {
      ...
      "card_summary_ja": "卓越した研究者が大型で特に重要な研究計画を推進する最上位級の種目です。研究構想の独創性と研究組織の説得力が重いため、公募要領と S-1 の要求水準を早めに確認します。",
      "card_summary_zh": "面向在学术上处于突出地位、拟推进大型且特别重要研究计划的最高层级项目。重点是及早把握公募要领与 S-1 对研究构想和研究组织的高要求。",
      "card_summary_en": "Top-tier scheme for outstanding researchers leading large and especially important research programs. Because originality and the credibility of the research organization are central, review the application procedures and S-1 requirements early.",
    ...
    },
    {
      ...
      "card_summary_ja": "JSPS 特別研究員（PD・DC・RPD など）が採用期間中に自らの研究計画を遂行するための奨励費です。自分のフェロー区分に対応する交付条件と使用ルールを、本体制度とセットで確認します。",
      "card_summary_zh": "面向 JSPS 特别研究员（PD、DC、RPD 等）在资助期间执行自身研究计划的奨励费。重点是把与本人 fellowship 区分对应的经费规则和使用条件，与本体制度一起核对。",
      "card_summary_en": "Grant-in-aid for JSPS Research Fellows such as PD, DC, and RPD to carry out their own research plans during the fellowship period. Review the spending rules and award conditions together with the underlying fellowship track that applies to you.",
    ...
    },
    {
      ...
      "card_summary_ja": "CPD 制度の過去位置づけを確認するための参照カードです。現行ページでは募集停止が明示されているため、新規応募の検討ではなく制度比較用として扱います。",
      "card_summary_zh": "这是用于确认 CPD 制度既往定位的参考卡片。当前官方页面已明确写明募集停止，因此它应作为制度比较参考，而不是当前申请入口。",
      "card_summary_en": "Reference entry for understanding the former position of the CPD scheme. The official page explicitly marks it as suspended, so use it for scheme comparison rather than active application planning.",
    ...
    },
    {
      ...
      "card_summary_ja": "研究成果を学術図書・データベース・公開発表などの形で社会と学術界へ届けるための事業です。どの成果公開区分に該当するかを見極め、必要な様式と実施計画を区分ごとに確認します。",
      "card_summary_zh": "用于将研究成果以学术图书、数据库、公开发表等形式向学界和社会发布的项目。应先判断属于哪一种成果公开类别，再分别核对所需样式与实施计划。",
      "card_summary_en": "Scheme for disseminating research results through scholarly books, databases, public outreach, and related formats. First determine the correct publication-dissemination category, then confirm the required forms and implementation plan for that route.",
  ...
  "timeline": [
    ...
    },
    {
      ...
      "program_title": "若手研究",
      "program_title_ja": "若手研究",
      "program_title_zh": "青年研究（若手研究）",
      "program_title_en": "Early-Career Scientists",
      "theme": "tohoku",
      "type": "notice",
      "title_ja": "公募通知の公開",
      "title_zh": "官方通知发布",
      ...
      "datetime": null,
      "status": "past",
      "note_ja": "若手研究の公募通知が公開された日です。",
      "note_zh": "青年研究（若手研究）的公募通知发布日期。",
      "note_en": "Official notice date for Early-Career Scientists."
    },
    {
    ...
    },
    {
      ...
      "datetime": null,
      "status": "past",
      "note_ja": "電子申請システムの利用開始日。対象種目は 若手研究 です。",
      "note_zh": "电子申报系统可开始用于 青年研究（若手研究） 的日期。",
    ...
    },
    {
      ...
      "datetime": null,
      "status": "past",
      "note_ja": "研究活動スタート支援の公募通知が公開された日です。",
      "note_zh": "研究活动启动支援的公募通知发布日期。",
      "note_en": "Official notice date for Research Activity Start-up Support."
    },
    {
      ...
      "datetime": null,
      "status": "past",
      "note_ja": "公募期間開始。JSPS 締切は 2026-05-08 16:30 JST です。",
      "note_zh": "公募期开始；JSPS 截止为 2026-05-08 16:30 JST。",
    ...
    },
    {
      ...
      "datetime": null,
      "status": "past",
      "note_ja": "電子申請システムの利用開始日。対象種目は 研究活動スタート支援 です。",
      "note_zh": "电子申报系统可开始用于 研究活动启动支援 的日期。",
    ...
    },
    {
      ...
      "title_ja": "次年度公募開始（予定）",
      "title_zh": "下一轮公募开始（预计）",
      "title_en": "Next-cycle call opens (planned)",
      "date": "2026-04-10",
      "datetime": null,
      "status": "upcoming",
      "note_ja": "令和9(2027)年度公募予定に基づく予定日です。",
      "note_zh": "基于“2027年度预计公募日程”整理的预计日期。",
      "note_en": "Planned date based on the FY2027 planned call schedule."
    },
    {
    ...
    },
    {
      ...
      "theme": "usst",
      "type": "deadline",
      "title_ja": "次年度 JSPS 締切（予定）",
      "title_zh": "下一轮 JSPS 截止（预计）",
      "title_en": "Next-cycle JSPS deadline (planned)",
      "date": "2026-06-16",
      "datetime": null,
      "status": "upcoming",
      "note_ja": "令和9(2027)年度公募予定に基づく予定締切です。",
      "note_zh": "基于“2027年度预计公募日程”整理的预计截止日期。",
      "note_en": "Planned deadline based on the FY2027 planned call schedule."
    },
    {
    ...
    },
    {
      ...
      "datetime": null,
      "status": "upcoming",
      "note_ja": "令和8(2026)年度公募予定に基づく予定日です。",
      "note_zh": "基于“2026年度预计公募日程”整理的预计日期。",
      "note_en": "Planned date based on the FY2026 planned call schedule."
    },
    {
    ...
    },
    {
      ...
      "datetime": null,
      "status": "upcoming",
      "note_ja": "令和8(2026)年度公募予定に基づく予定締切です。",
      "note_zh": "基于“2026年度预计公募日程”整理的预计截止日期。",
      "note_en": "Planned deadline based on the FY2026 planned call schedule."
    },
    {
  ...
  "guides": [
    {
      ...
      "summary_ja": "まずは JSPS の公募情報総索引から全体像を確認し、必要な種目ページへ進みます。",
      "summary_zh": "先从官方公募信息总索引看所有种目，再进入对应项目页面。",
      "summary_en": "Start from the official KAKENHI public-call index, then jump to each program page.",
      "href": "https://www.jsps.go.jp/j-grantsinaid/02_koubo/index.html",
      "kind": "page",
      "group": "Core",
      "group_ja": "共通入口",
      "group_zh": "核心入口",
      "group_en": "Core entry points"
    },
    {
      "id": "faq",
      "title_ja": "科研費FAQ",
      ...
      "summary_ja": "制度、手続、応募資格を確認するときの基本 FAQ 入口です。",
      "summary_zh": "申请准备阶段最常查的制度性问答入口。",
      "summary_en": "The main official FAQ hub for procedural and eligibility questions.",
      "href": "https://www.jsps.go.jp/j-grantsinaid/01_seido/05_faq/index.html",
      "kind": "page",
      "group": "Core",
      "group_ja": "共通入口",
    ...
    {
      "id": "system",
      "title_ja": "科研費電子申請システム",
      "title_zh": "科研费电子申报系统",
      "title_en": "Electronic application system",
      "summary_ja": "研究計画調書の入力と提出に使う正式なオンライン申請入口です。",
      "summary_zh": "正式录入和提交研究计划调书时使用。",
      "summary_en": "Use this for formal online entry and submission.",
      "href": "https://www-shinsei.jsps.go.jp/kaken/index.html",
      "kind": "system",
      "group": "Core",
      "group_ja": "共通入口",
    ...
    },
    {
      ...
      "title_zh": "e-Rad",
      "title_en": "e-Rad",
      "summary_ja": "申請準備に入る前に、研究者情報と応募資格の登録状況を確認します。",
      "summary_zh": "在开始写材料前先核对研究者信息和応募資格。",
      "summary_en": "Verify researcher registration and eligibility before preparing the proposal.",
      "href": "https://www.e-rad.go.jp/",
      "kind": "external",
      "group": "Core",
      "group_ja": "共通入口",
    ...
    },
    {
      ...
      "title_ja": "研究活動スタート支援：公式ページ",
      "title_zh": "研究活动启动支援：官方页面",
      "title_en": "Research Activity Start-up Support: Official page",
    ...
    },
    {
      ...
      "title_ja": "研究活動スタート支援：ローカルスナップショット",
      "title_zh": "研究活动启动支援：本地快照",
      "title_en": "Research Activity Start-up Support: Local snapshot",
      "summary_ja": "研究活動スタート支援 の公式ページからたどる主要導線です。",
      "summary_zh": "从 研究活动启动支援 官方入口整理出的关键跳转。",
      "summary_en": "Key jump-out link surfaced from the official Research Activity Start-up Support page.",
      "href": "external/jsps/2026-04-08/22_startup_support__download.html",
    ...
    },
    {
      ...
      "title_ja": "若手研究：公募予定通知",
      "title_zh": "青年研究（若手研究）：预计日程通知",
      "title_en": "Early-Career Scientists: Schedule notice",
      "summary_ja": "若手研究 の公式ページからたどる主要導線です。",
      "summary_zh": "从 青年研究（若手研究） 官方入口整理出的关键跳转。",
      "summary_en": "Key jump-out link surfaced from the official Early-Career Scientists page.",
      "href": "https://www.jsps.go.jp/file/storage/kaken_g_4570/r8jimurenraku.pdf",
    ...
    },
    {
      ...
      "title_ja": "若手研究：予定日程スナップショット",
      "title_zh": "青年研究（若手研究）：预计日程快照",
      "title_en": "Early-Career Scientists: Schedule snapshot",
      "summary_ja": "若手研究 の公式ページからたどる主要導線です。",
      "summary_zh": "从 青年研究（若手研究） 官方入口整理出的关键跳转。",
      "summary_en": "Key jump-out link surfaced from the official Early-Career Scientists page.",
      "href": "external/jsps/2026-04-08/kaken_r8_schedule_notice.pdf",
    ...
    },
    {
      ...
      "summary_ja": "若手研究 の確認優先度が高い資料です。",
      "summary_zh": "青年研究（若手研究） 的重点参考材料。",
      "summary_en": "Priority reference document for Early-Career Scientists.",
    ...
    },
    {
      ...
      "title_ja": "独立基盤形成支援（試行）：公募要領（PDF/479KB）（4月7日更新）",
      "title_zh": "独立基盘形成支援（试行）：公募要領（PDF/479KB）（4月7日更新）",
      "title_en": "Independent Research Base Building Support (Pilot): 公募要領（PDF/479KB）（4月7日更新）",
      "summary_ja": "独立基盤形成支援（試行） の確認優先度が高い資料です。",
      "summary_zh": "独立基盘形成支援（试行） 的重点参考材料。",
      "summary_en": "Priority reference document for Independent Research Base Building Support (Pilot).",
    ...
    },
    {
      ...
      "title_ja": "独立基盤形成支援（試行）：正誤表（PDF/117KB）（4月7日掲載）",
      "title_zh": "独立基盘形成支援（试行）：正誤表（PDF/117KB）（4月7日掲載）",
      "title_en": "Independent Research Base Building Support (Pilot): 正誤表（PDF/117KB）（4月7日掲載）",
      "summary_ja": "独立基盤形成支援（試行） の確認優先度が高い資料です。",
      "summary_zh": "独立基盘形成支援（试行） 的重点参考材料。",
      "summary_en": "Priority reference document for Independent Research Base Building Support (Pilot).",
    ...
    },
    {
      ...
      "summary_ja": "FAQ ページからたどれる公式リソースです。科研費ＦＡＱ",
      "summary_zh": "FAQ 页面中的官方链接。科研費ＦＡＱ",
      "summary_en": "Official resource linked from the FAQ page. 科研費ＦＡＱ",
    ...
    },
    {
      ...
      "summary_ja": "FAQ ページからたどれる公式リソースです。テーマ別ＦＡＱ",
      "summary_zh": "FAQ 页面中的官方链接。テーマ別ＦＡＱ",
      "summary_en": "Official resource linked from the FAQ page. テーマ別ＦＡＱ",
    ...
    },
    {
      ...
      "summary_ja": "FAQ ページからたどれる公式リソースです。研究種目別ＦＡＱ",
      "summary_zh": "FAQ 页面中的官方链接。研究種目別ＦＡＱ",
      "summary_en": "Official resource linked from the FAQ page. 研究種目別ＦＡＱ",
  ...
  "source_registry": [
    ...
    },
    {
      ...
      "official_url": "https://www.jsps.go.jp/j-grantsinaid/36_dokuritsu_kiban/download.html",
      "snapshot_path": "external/jsps/2026-04-08/36_dokuritsu_kiban__download.html",
      "summary_ja": "独立基盤形成支援（試行） の公式ページです。5 件の文書資源と 0 件の様式系統を確認できます。",
      "summary_zh": "独立基盘形成支援（试行） 对应的官方页面，含 5 个文档资源和 0 个表格家族线索。",
      "summary_en": "Official page for Independent Research Base Building Support (Pilot), with 5 document resources and 0 form-family traces.",
      "resource_count": 6,
      "kind": "program"
    },
    {
  ...
  "call_catalog": [
    {
      ...
      "title_en": "Research Activity Start-up Support",
      "subtitle": "研究活動スタート支援",
      "subtitle_ja": "研究活動スタート支援",
      "subtitle_zh": "研究活动启动支援",
      "subtitle_en": "Research Activity Start-up Support",
      "group": "重点项目",
      "group_ja": "重点種目",
      "group_zh": "重点项目",
      "group_en": "Priority programs",
