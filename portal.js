...
const I18N = {
  en: {
    ...
    hero: {
      ...
      affiliation:
        "High Performance Computing Division ・ High Performance Computing Laboratory, Cyberscience Center, Tohoku University",
      description: "",
  ...
  zh: {
    ...
    hero: {
      ...
      role: "助理教授",
      affiliation: "东北大学网络科学中心高性能计算研究部・高性能计算研究室",
      description: "",
      portraitAlt: "陶思晨照片",
      scrollCue: "进入工作区",
    },
  ...
  ja: {
    ...
    hero: {
      ...
      role: "助教",
      affiliation: "東北大学サイバーサイエンスセンター 高性能計算研究部・高性能計算研究室",
      description: "",
